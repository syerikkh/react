...
export const MainContact = () => {
    return (
        <div class="lg:py-24 lg:px-20 py-16 px-4 lg:w-[1440px]">
            <div class="lg:px-8 flex flex-col lg:gap-24 gap-6 justify-center items-center dark:text-[#F9FAFB]">
                ...
                <div class="flex flex-col justify-center items-center gap-2 text-base text-gray-600 dark:text-[#D1D5DB]">
