...
export const MainExperience = () => {
    return (
        <div class="lg:py-24 lg:px-20 lg:w-[1440px] bg-gray-50">
            <div class="lg:px-8 lg:flex lg:flex-col lg:gap-12 lg:justify-center lg:items-center">
                <div class="lg:flex lg:justify-center lg:items-center lg:flex-col lg:gap-4">
                    ...
                    <div class="lg:flex lg:flex-col lg:gap-12">
                        <div class="lg:p-8 lg:flex lg:gap-12 lg:justify-center shadow-[0px_2px_2px_0px_grey] rounded-xl">
                            <UpworkIcon />
                        ...
                        <div class="lg:p-8 lg:flex lg:gap-12 lg:shadow-[0px_2px_2px_0px_grey] rounded-xl lg:justify-between">
                            <UpworkIcon />
                            <div class="lg:flex lg:flex-col lg:gap-4 max-lg:w-[384px]">
